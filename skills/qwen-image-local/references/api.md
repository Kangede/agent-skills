...
4. LocalLLMProxy, OpenAI-compatible, or Anthropic-compatible session environment variables listed in `config/defaults.json`.
...
| `generator_device` | Fixed to `cpu` for the request RNG, matching the SGLang cookbook example. |
...
- SGLang Qwen-Image-2.1 cookbook and transparent-output behavior: <https://docs.sglang.io/cookbook/diffusion/Qwen-Image/Qwen-Image-2.1>
